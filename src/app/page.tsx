...
import { Center, Button, Paper, Container, Title, Text, Divider, Card, Flex, Progress } from '@mantine/core';
...
const BucketList = ({ buckets }: any) => {
  return (
    <div className='flex flex-col overflow-auto flex-nowrap gap-1 max-h-96'>
      {
        buckets.map((bucket: Bucket) => {
          const p = bucket.total === 0 ? null : bucket.index / bucket.total;
          ...
          return (
            ...
            >
              <Flex justify="space-between">
                ...
                <Text>{p !== null ? Math.round(p * 100) : '-'}%</Text>
              </Flex>

              <Progress className='absolute bottom-0' value={p ? p * 100 : 0} />
            </Card>
          );
        })
      }
